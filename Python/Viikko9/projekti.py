...
def print_command(network, namelist):
    ...
    for name in sorted(network):
        print(name)
        for friend_name in sorted(network[name]):
            print(f"- {friend_name}")
