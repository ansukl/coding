...
COMP.CS.100 Ohjelmointi 1
            Programming 1
10.3 Laajennettu Person-luokka
The first example of a home made class. Extending the existing class.
...
class Person:
    ...
    def move(self, new_address):
        ...
        if new_address == self.__address:
            print("You cannot move to the same address.")
        else:
